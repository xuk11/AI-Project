...
/** uploadFilePath POST /api/file/upload/filepath */
export async function uploadFilePathUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.uploadFilePathUsingPOSTParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseString_>('/api/file/upload/filepath', {
    method: 'POST',
    params: {
      ...params,
    },

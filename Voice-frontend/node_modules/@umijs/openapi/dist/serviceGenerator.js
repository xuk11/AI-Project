...
class ServiceGenerator {
    constructor(config, openAPIData) {
        ...
        if ((_a = this.config.hook) === null || _a === void 0 ? void 0 : _a.afterOpenApiDataInited) {
            this.openAPIData =
        ...
        const hookCustomFileNames = ((_b = this.config.hook) === null || _b === void 0 ? void 0 : _b.customFileNames) || defaultGetFileTag;
            ...
            ['get', 'put', 'post', 'delete', 'patch'].forEach((method) => {
                ...
                tags.forEach((tagString) => {
                    const tag = this.config.isCamelCase
                        ? lodash_1.camelCase(resolveTypeName(tagString))
        ...
        return Object.keys(this.apiData)
            ...
            !api.path.includes('${'))
                ...
                try {
                    ...
                    return Object.assign(Object.assign({}, newApi), { functionName: this.config.isCamelCase ? lodash_1.camelCase(functionName) : functionName, typeName: this.getTypeName(newApi), path: getPrefixPath(), pathInComment: formattedPath.replace(/\*/g, '&#42;'), hasPathVariables: formattedPath.includes('{'), hasApiPrefix: !!this.config.apiPrefix, method: newApi.method, 
            ...
            return {
                genType: 'ts',
                className,
                instanceName: `${(_a = fileName[0]) === null || _a === void 0 ? void 0 : _a.toLowerCase()}${fileName.substr(1)}`,
                list: genParams,
            };
        })
            .filter((ele) => { var _a; return !!((_a = ele === null || ele === void 0 ? void 0 : ele.list) === null || _a === void 0 ? void 0 : _a.length); });
    }

...
public class FileManager {
    ...
    public String uploadFile(MultipartFile multipartFile, String uploadPathPrefix) {
        ...
        try {
            ...
            String resultUrl = "/" + uploadPathPrefix.replace("/", "%2F") + "%2F" + uploadFilename;
            return cosClientConfig.getHost() + resultUrl;
        } catch (Exception e) {
    ...
    public String uploadVideo(MultipartFile multipartFile, String uploadPathPrefix) {
    ...
    private void validFile(MultipartFile multipartFile) {
        ...
        ThrowUtils.throwIf(fileSize > 200 * ONE_M, ErrorCode.PARAMS_ERROR, "文件大小不能超过 200MB");
        // 2. 校验文件后缀
        String fileSuffix = FileUtil.getSuffix(multipartFile.getOriginalFilename());
        // 允许上传的文件后缀列表（或者集合）
        final List<String> ALLOW_FORMAT_LIST = Arrays.asList("mp3", "mp4", "wav", "jpg", "jpeg", "png");
        ThrowUtils.throwIf(!ALLOW_FORMAT_LIST.contains(fileSuffix), ErrorCode.PARAMS_ERROR, "文件类型错误");
    }

    private void validFile(String fileUrl) {

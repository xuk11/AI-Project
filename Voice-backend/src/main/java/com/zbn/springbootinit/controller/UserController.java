...
import com.zbn.springbootinit.utils.JwtUtil;
...
public class UserController {
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        int type = userLoginRequest.getType();
    ...
    @PostMapping("/login/ByJwt")
    public BaseResponse<String> userLoginByJwt(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        if (userLoginRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        String userAccount = userLoginRequest.getUserAccount();
